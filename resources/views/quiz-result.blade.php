...
<div class="flex flex-col min-h-screen items-center bg-gray-100">
    ...
    <a href="/certificate" class="text-green-500 font-bold p-5">View and download Certificate</a>
    @endif
     <div class="w-200"> 
        <h1 class="text-2xl font-bold text-green-900 text-center my-5"> 
            {{$correctAnswers}}  out of  {{count($resultData)}} are Correct</h1>
